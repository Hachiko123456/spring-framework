...
public class RootBeanDefinition extends AbstractBeanDefinition {
	...
	/**
	 * 在AOP代理时会将原始的BeanDefinition存放到该属性中
	 */
	@Nullable
	...
	/**
	 *resolvedConstructorOrFactoryMethod、constructorArgumentsResolved、resolvedConstructorArguments、preparedConstructorArguments
	 * 四个变量的锁
	 */
	...
	/**
	 * 生成bean的构造方法或者工厂方法，Executable是Method、Constructor类型的父类
	 */
	@Nullable
	...
	/**
	 * 待解析的构造函数参数，即还没有找到对应的实例，可以理解为还没有注入依赖的形参
	 */
	@Nullable
	...
	/**
	 * postProcessed、beforeInstantiationResolved两个变量的锁
	 */
	 ...
	 */
	/**
	 * Constructor、Field、Method都实现了这个接口，这是集合是用来存储它们的信息的
	 */
	@Nullable
