...
public class PropertyEditorRegistrySupport implements PropertyEditorRegistry {
	...
	//---------------------------------------------------------------------
	// Management of default editors 管理默认的属性编辑器
	//---------------------------------------------------------------------
	...
	/**
	 * 获取requireType对应的默认属性编辑器，如果没有默认的属性编辑器，则初始化属性编辑器
	...
	//---------------------------------------------------------------------
	// Management of custom editors 管理自定义编辑器
	//---------------------------------------------------------------------
