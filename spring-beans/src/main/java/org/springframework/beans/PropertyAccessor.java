...
public interface PropertyAccessor {
	...
	/**
	 * 级联属性分割符，例如foo.bar最终会被解析成getFoo().getBar()两个方法
	...
	/**
	 * 代表角标index的符号  如person.addresses[0]
	 * 可以对集合、Map、数组等对象执行该运算方式
	...
	/**
	 * 获取对象中的propertyName所代表的数据类型，可以解析嵌套类型的情况
