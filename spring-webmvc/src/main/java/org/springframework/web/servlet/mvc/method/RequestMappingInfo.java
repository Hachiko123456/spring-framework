...
public final class RequestMappingInfo implements RequestCondition<RequestMappingInfo> {
	...
	@Nullable
	//请求路劲条件（该对象完成了URL合并，筛选URL，择优URL）
	...
	public RequestMappingInfo getMatchingCondition(HttpServletRequest request) {
		 ...
		 * 因为当前RequestMappingInfo对象，一个methodsCondition可以配置GET、POST、DELETE等条件
		 * 但是实际就匹配到一个请求类型，此时methods只代表匹配的那个
		 */
		return new RequestMappingInfo(
	...
	public int compareTo(RequestMappingInfo other, HttpServletRequest request) {
		...
		/**
		 * 依次比较 pathPatternsCondition、patternsCondition、paramsCondition、headersCondition、consumesCondition、
