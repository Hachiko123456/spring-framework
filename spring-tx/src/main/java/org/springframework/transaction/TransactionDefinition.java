...
public interface TransactionDefinition {
	...
	/**
	 * 默认传播级别，如果当前正处于一个事务中，则加入，否则创建一个事务
	...
	/**
	 * 无论如何都会创建一个新的事务，如果正处于一个事务中，会先挂起，然后创建
