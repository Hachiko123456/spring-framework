...
public abstract class AbstractApplicationContext extends DefaultResourceLoader
	...
	/**
	 * 如果没有环境配置，则默认用StandardEnvironment
	...
	/**
	 * 在这里初始化ResourcePatternResolver对象为PathMatchingResourcePatternResolver对象的实例，支持Ant风格解析
	...
	public void refresh() throws BeansException, IllegalStateException {
		synchronized (this.startupShutdownMonitor) {
			...
			try {
				...
				//往beanFactory中注册BeanFactoryProcessor
				registerBeanPostProcessors(beanFactory);
				beanPostProcess.end();

				// Initialize message source for this context.
				//初始化MessageSource，默认DelegatingMessageSource
				initMessageSource();

				// Initialize event multicaster for this context.
				//初始化ApplicationEventMulticaster，默认SimpleApplicationEventMulticaster
				...
				//事件广播、把earlyApplicationEvents置为null
				registerListeners();
	...
	/**
	 * 检测beanFactory中是否有配置applicationEventMulticaster，如果没有则默认使用SimpleApplicationEventMulticaster
	...
	public Resource[] getResources(String locationPattern) throws IOException {
		//构造器中初始化为PathMatchingResourcePatternResolver
